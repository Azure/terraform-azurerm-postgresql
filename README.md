...
| <a name="input_server_version"></a> [server\_version](#input\_server\_version)                                                             | Specifies the version of PostgreSQL to use. Valid values are `9.5`, `9.6`, `10.0` and `11`. Changing this forces a new resource to be created.                                                                                                                                                                                    | `string`                                                                                                                                                                                                                                                                                                                                                                                                                                           | `"9.5"`                        |    no    |
